...
/// SignatureBundle carries legacy, PQ, or hybrid signature material.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SignatureBundle {
    #[prost(bytes = "vec", tag = "1")]
    pub ed25519_signature: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "2")]
    pub ml_dsa_65_signature: ::prost::alloc::vec::Vec<u8>,
}
/// PublicKeyBundle carries algorithm-aware public key material.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PublicKeyBundle {
    #[prost(bytes = "vec", tag = "1")]
    pub ed25519_public_key: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "2")]
    pub ml_dsa_65_public_key: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "3")]
    pub x25519_public_key: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "4")]
    pub ml_kem_768_public_key: ::prost::alloc::vec::Vec<u8>,
}
/// ProofOfPossessionBundle carries proof-of-possession signatures for a key bundle.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ProofOfPossessionBundle {
    #[prost(bytes = "vec", tag = "1")]
    pub ed25519_pop: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "2")]
    pub ml_dsa_65_pop: ::prost::alloc::vec::Vec<u8>,
}
/// KeyWrapParams generalizes payload key wrapping beyond legacy HPKE-only profiles.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct KeyWrapParams {
    #[prost(enumeration = "KeyWrapScheme", tag = "1")]
    pub scheme: i32,
    #[prost(string, tag = "2")]
...
/// RecipientKeyWrap carries legacy, PQ, or hybrid key-wrap material.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RecipientKeyWrap {
    #[prost(uint32, tag = "1")]
    pub recipient_kid: u32,
    #[prost(enumeration = "KeyWrapScheme", tag = "2")]
    pub wrap_scheme: i32,
    #[prost(bytes = "vec", tag = "3")]
    pub x25519_enc: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "4")]
    pub ml_kem_ciphertext: ::prost::alloc::vec::Vec<u8>,
...
pub struct EventEnvelope {
    ...
    /// Ed25519 signature (64 bytes, legacy)
    ...
    /// === PQC Signature Fields (VES-PQC-1) ===
    #[prost(enumeration = "SignatureScheme", tag = "19")]
    pub agent_signature_scheme: i32,
    #[prost(message, optional, tag = "20")]
    pub agent_signature_bundle: ::core::option::Option<SignatureBundle>,
}
...
pub struct EncryptedPayload {
    ...
    /// PQC key-wrap parameters (VES-PQC-1)
    #[prost(message, optional, tag = "8")]
    pub key_wrap_params: ::core::option::Option<KeyWrapParams>,
    #[prost(message, repeated, tag = "9")]
    pub recipient_wraps: ::prost::alloc::vec::Vec<RecipientKeyWrap>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct SequencedEvent {
    ...
    /// PQC receipt signature (VES-RECEIPT-2)
    #[prost(enumeration = "SignatureScheme", tag = "5")]
    pub receipt_signature_scheme: i32,
    #[prost(message, optional, tag = "6")]
    pub receipt_signature_bundle: ::core::option::Option<SignatureBundle>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct RegisterKeyRequest {
    ...
    pub key_type: i32,
    /// 32 bytes Ed25519 or X25519 (legacy)
    #[prost(bytes = "vec", tag = "5")]
    ...
    /// Signature proving ownership (legacy)
    #[prost(bytes = "vec", tag = "8")]
    pub proof_of_possession: ::prost::alloc::vec::Vec<u8>,
    /// PQC key registration fields (VES-KEY-2)
    #[prost(enumeration = "KeyAlgorithm", tag = "9")]
    pub key_algorithm: i32,
    #[prost(message, optional, tag = "10")]
    pub public_key_bundle: ::core::option::Option<PublicKeyBundle>,
    #[prost(message, optional, tag = "11")]
    pub proof_of_possession_bundle: ::core::option::Option<ProofOfPossessionBundle>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// SignatureScheme identifies the signature profile used for an artifact.
...
impl SignatureScheme {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::MlDsa65 => "SIGNATURE_SCHEME_ML_DSA_65",
            Self::Ed25519MlDsa65 => "SIGNATURE_SCHEME_ED25519_ML_DSA_65",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SIGNATURE_SCHEME_ML_DSA_65" => Some(Self::MlDsa65),
            "SIGNATURE_SCHEME_ED25519_ML_DSA_65" => Some(Self::Ed25519MlDsa65),
            _ => None,
        }
    }
}
/// KeyAlgorithm identifies the concrete key algorithm or hybrid bundle.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
impl KeyAlgorithm {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Ed25519 => "KEY_ALGORITHM_ED25519",
            Self::X25519 => "KEY_ALGORITHM_X25519",
            Self::MlDsa65 => "KEY_ALGORITHM_ML_DSA_65",
            Self::MlKem768 => "KEY_ALGORITHM_ML_KEM_768",
            Self::Ed25519MlDsa65 => "KEY_ALGORITHM_ED25519_ML_DSA_65",
            Self::X25519MlKem768 => "KEY_ALGORITHM_X25519_ML_KEM_768",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "KEY_ALGORITHM_ED25519" => Some(Self::Ed25519),
            "KEY_ALGORITHM_X25519" => Some(Self::X25519),
            "KEY_ALGORITHM_ML_DSA_65" => Some(Self::MlDsa65),
            "KEY_ALGORITHM_ML_KEM_768" => Some(Self::MlKem768),
            "KEY_ALGORITHM_ED25519_ML_DSA_65" => Some(Self::Ed25519MlDsa65),
            "KEY_ALGORITHM_X25519_ML_KEM_768" => Some(Self::X25519MlKem768),
            _ => None,
        }
    }
}
/// KeyWrapScheme identifies how a payload DEK is wrapped for a recipient.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
impl KeyWrapScheme {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "KEY_WRAP_SCHEME_UNSPECIFIED",
            Self::X25519HkdfSha256 => "KEY_WRAP_SCHEME_X25519_HKDF_SHA256",
            Self::MlKem768 => "KEY_WRAP_SCHEME_ML_KEM_768",
            Self::X25519MlKem768 => "KEY_WRAP_SCHEME_X25519_ML_KEM_768",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "KEY_WRAP_SCHEME_UNSPECIFIED" => Some(Self::Unspecified),
            "KEY_WRAP_SCHEME_X25519_HKDF_SHA256" => Some(Self::X25519HkdfSha256),
            "KEY_WRAP_SCHEME_ML_KEM_768" => Some(Self::MlKem768),
            "KEY_WRAP_SCHEME_X25519_ML_KEM_768" => Some(Self::X25519MlKem768),
            _ => None,
        }
    }
}
